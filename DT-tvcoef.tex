...
\NormalTok{res\_oos }\OtherTok{\textless{}{-}} \FunctionTok{ts.union}\NormalTok{(oos\_reg\_morc}\SpecialCharTok{$}\NormalTok{residuals, oos\_lm}\SpecialCharTok{$}\NormalTok{residuals)}
...
\NormalTok{  reg\_lin\_covid, }
  \AttributeTok{fixed\_var\_intercept =} \ConstantTok{FALSE}\NormalTok{,}
  \AttributeTok{fixed\_var\_variables =} \FunctionTok{c}\NormalTok{(}\ConstantTok{FALSE}\NormalTok{, }\ConstantTok{FALSE}\NormalTok{, }\FunctionTok{rep}\NormalTok{(}\ConstantTok{TRUE}\NormalTok{, }\DecValTok{4}\NormalTok{))}
\NormalTok{)}
